...
namespace GeeekHouseAPI.Repository
{
    public interface IProductRepository
    {
        ...
        Task<GenericResponse<string>> EditProduct(ProductModel productModel, int category, int subcategoryId, int availability);
        ...
        Task<GenericResponse<string>> DisableProduct(int productId);
